...
<h1 style="margin-left: 72px;" class="h4 text-gray-900 mb-4 text-center">Secure Account</h1> 
    ...
    <?php echo form_open('indexcontrol/create_newpass/'.$id->u_id.'', $attributes); ?>
     ...
     <div style="margin-left: 45px;" class="form-group row">
       ...
       <span style="margin-left: 3%;" id="eyeo" class="fa fa-eye"></span>
        <input id="newpass" type="password" class="form-control mb-4 <?= (form_error('newpass') == "" ? '':'is-invalid') ?>"  name="newpass" placeholder="Enter New Password" >
       <div class="text-danger text-center"><?php echo form_error('newpass'); ?></div>
       <?php echo form_label('Confirm Password') ?>
        <input type="password" class="form-control mb-4 <?= (form_error('cpass') == "" ? '':'is-invalid') ?>"  name="cpass" placeholder="Confirm Password" >
       <div class="text-danger text-center"><?php echo form_error('cpass'); ?></div>
     </div>
     <button style="margin-left: 149px;" type="submit" class="btn btn-primary mb1 bg-blue" name="submit">
