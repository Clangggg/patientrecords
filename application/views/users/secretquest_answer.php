...
<h1 style="margin-left: 72px;" class="h4 text-gray-900 mb-3 text-center">Secret Question</h1> 
    ...
    <?php echo form_open('indexcontrol/forgot_secretquestion/'.$id->u_id.'', $attributes); ?>
     ...
     <button style="margin-left: 149px;" type="submit" class="btn btn-primary mb1 bg-blue mt-3" name="submit">
