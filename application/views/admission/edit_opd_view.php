           ...
           <?php endif; ?>
              ...
              <div class="row">
                  ...
                  <div style="margin-left: 1px;" class="col-sm-4 mb-3">
                   ...
                   <input type="text" minlenght="12" maxlength="12" class="form-control  <?= (form_error('lrn') == "" ? '':'is-invalid') ?>"  name="lrn" placeholder="LRN" value="<?php echo $pr_id->pr_id ?>">
                  ...
                  <div class="text-danger text-center"><?php echo form_error('fname'); ?></div>
                     ...
                     <div class="col-sm-3">
                      <?php echo form_label('Middlename'); ?>
                       <input type="text" style="margin-left: 2px;" class="form-control  <?= (form_error('middlen') == "" ? '':'is-invalid') ?>"  name="middlen" placeholder="Middlename" value="<?php echo $pr_id->pr_mname ?>">
                  ...
                  <div class="text-danger text-center"><?php echo form_error('age'); ?></div>  
                     ...
                     <div style="margin-left: 4px; margin-top: 10px;" class="col-sm-3">
                       <?php echo form_label('Birthplace'); ?>
                                <input type="text" class="form-control  <?= (form_error('birthplace') == "" ? '':'is-invalid') ?>" placeholder="Birthplace"  name="birthplace" value="<?php echo $pr_id->pr_bplace ?>">
                     ...
                     <div style="margin-left: 4px; margin-top: 10px;" class="col-sm-3">
                       <?php echo form_label('Vaccination Status'); ?>
                        ...
                        <option value=<?php echo $pr_id->pr_vaccinestat; ?><?php echo set_select('vaccinestat', $pr_id->pr_vaccinestat); ?>><?php echo $pr_id->pr_vaccinestat; ?></option>
                    ...
                    <?php endif; ?> 
                     ...
                     <?php echo form_label('Division'); ?>
                       ...
                       <option value=<?php echo $pr_id->pr_divi; ?><?php echo set_select('divi', $pr_id->pr_divi); ?>><?php echo $pr_id->pr_divi; ?></option>
                     ...
                     <div style="margin-left: 5px; margin-top: 10px;" class="col-sm-4">
                      <?php echo form_label('School'); ?>
                                <input type="text" class="form-control <?= (form_error('occup') == "" ? '':'is-invalid') ?>" placeholder="School name"  name="occup" value="<?php echo $pr_id->pr_occup ?>">
                   ...
                   <div class="text-danger text-center"><?php echo form_error('gen'); ?></div>
                    ...
                    <div style="margin-left: 20px; margin-top: 10px;" class="col-xs-3">
                        <?php echo form_label('Parent/Guardian'); ?>
                                <input type="text" class="form-control <?= (form_error('religion') == "" ? '':'is-invalid') ?>" placeholder="Parent/Guardian"  name="religion" value="<?php echo $pr_id->pr_religion ?>">
