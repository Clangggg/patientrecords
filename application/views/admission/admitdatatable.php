          ...
          <div class="card shadow mb-4">
            ...
            <!-- Page Heading -->
          <h5 class="mb-0 text-gray-800">Student Records Table <a style="margin-left: 750px; font-size: 17px;" href="<?php echo base_url(); ?>admissioncontrol/opd_form" >
                    <i class="fa fa-plus text-secondary"> Add</i>
                  </a>   
                  </h5>  
