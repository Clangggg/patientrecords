         ...
         <div class="col-sm-6">
             ...
             <div style="margin-bottom:17px;">
                 <div class="row no-gutters">
                     <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Details of Examination</div>
                 </div>
             ...
             <div style="margin-bottom:17px; margin-top:10px;">
                 ...
                 <div style="margin-top:10px;" class="row">
                     ...
                     <div class="col-sm-8 mt-4">
                         <div class="row no-gutters">
                             <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Nutritional Status
                             </div>
                         </div>
                         <div class="h5 mb-1 font-weight-bold text-gray-800">
         ...
         <div class="col-sm-6">
             <div style="margin-bottom:17px;">
                 ...
                 <div class="h5 mb-1 font-weight-bold text-gray-800"><input
                         class="form-control  <?= (form_error('e_physicalexam') == "" ? '':'is-invalid') ?>" type="text"
                         name="e_physicalexam" value="<?php echo $get_findings_view->f_physicalexam; ?>">
             ...
             <div style="margin-bottom:17px;">
                 ...
                 <div class="h5 mb-1 font-weight-bold text-gray-800"><input
                         class="form-control  <?= (form_error('e_diagnosis') == "" ? '':'is-invalid') ?>" type="text"
             ...
             <div style="margin-bottom:17px;">
                 <div class="row no-gutters">
                     <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Remarks/Intervention</div>
                 </div>
                 <div class="h5 mb-1 font-weight-bold text-gray-800">
