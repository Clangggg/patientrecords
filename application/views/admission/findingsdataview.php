        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="row ml-5">
                        ...
                        <div class="col-sm-4 ml-5">
                            ...
                            <div style="margin-bottom:17px; margin-left:50px;">
                                <div class="row no-gutters">
                                    <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1 ml-1">
                                        Weight
                                    </div>
                                </div>
                ...
                <div class="col-sm-12" style="margin-bottom:17px; margin-left:30px">
                    <div class="row no-gutters">
                        <div class="text-xs text-center font-weight-bold text-secondary text-uppercase mb-1 mt-3">
                            Examined
                            by
                        </div>
                    </div>
