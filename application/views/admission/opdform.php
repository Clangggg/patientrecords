            ...
            <div class="col-sm-12 ">
                ...
                <div class="row">
                    <div style="margin-left: 4px;" class="col-sm-4">
                        ...
                        <input type="text" minlength="12" maxlength="12"
                            ...
                            placeholder="Enter LRN" value="<?php echo set_value('lrn') ?>">
                ...
                <div class="row mt-4">
                    <div style="margin-left: 4px;" class="col-sm-3 ">
                        ...
                        <input type="text" class="form-control  <?= (form_error('lname') == "" ? '':'is-invalid') ?>"
                            name="lname" placeholder="Last name" value="<?php echo set_value('lname') ?>">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" style="margin-left: 2px;"
                            ...
                            placeholder="Middle name" value="<?php echo set_value('middlen') ?>">
                        <div class="text-danger text-center"><?php echo form_error('middlen'); ?></div>
                    </div>
                    <div class="col-sm-1">
                        <?php echo form_label('Suffix'); ?>
                        <input type="text" style="margin-left: 2px;"
                            class="form-control <?= (form_error('middlen') == "" ? '':'is-invalid') ?>" style="width:70%;" name="suffix"
                            value="<?php echo set_value('suffix') ?>">
                ...
                <div class="row">
                    <div style="margin-left: 4px; margin-top: 10px;" class="col-sm-11">
                        ...
                        <input type="text" style="margin-left: 7px;"
                            ...
                            placeholder="Permanent Address" value="<?php echo set_value('address') ?>">
                ...
                <div class="row">
                    ...
                    <div style="margin-left: 15px; margin-top: 10px;" class="col-xs-9">
                        ...
                        <input type="date"
                            class="form-control  <?= (form_error('datebirth') == "" ? '':'is-invalid') ?>"
                            name="datebirth" value="<?php echo set_value('datebirth') ?>">
                    ...
                    <div style="margin-left: 4px; margin-top: 10px;" class="col-sm-2">
                        ...
                        <input type="text" class="form-control  <?= (form_error('age') == "" ? '':'is-invalid') ?>"
                            name="age" placeholder="Age" value="<?php echo set_value('age') ?>">
                    ...
                    <div style="margin-left: 4px; margin-top: 10px;" class="col-sm-3">
                        ...
                        <input type="text"
                            class="form-control  <?= (form_error('birthplace') == "" ? '':'is-invalid') ?>"
                            placeholder="Birthplace" name="birthplace" value="<?php echo set_value('birthplace') ?>">
                    ...
                    <div style="margin-left: 5px; margin-top: 10px;" class="col-sm-4">
                        ...
                        <input type="text" class="form-control <?= (form_error('occup') == "" ? '':'is-invalid') ?>"
                            placeholder="School name" name="occup" value="<?php echo set_value('occup') ?>">
            ...
            <div class="row">
                ...
                <div style="margin-left: 30px; margin-top: 10px;" class="col-xs-3">
                    ...
                    <input type="text" maxlength="11"
                        class="form-control  <?= (form_error('number') == "" ? '':'is-invalid') ?>"
                        placeholder="Mobile/Tel No." name="number" value="<?php echo set_value('number') ?>">
                ...
                <div style="margin-left: 20px; margin-top: 10px;" class="col-sm-4">
                    ...
                    <input type="text" class="form-control  <?= (form_error('religion') == "" ? '':'is-invalid') ?>"
                        placeholder="Parent/Guardian name" name="religion" value="<?php echo set_value('religion') ?>">
