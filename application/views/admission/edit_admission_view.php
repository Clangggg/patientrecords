              ...
              <div class="card border-left-success shadow h-100 py-2">
               ...
               <div class="text-xs font-weight-bold text-success text-uppercase mb-1">LRN</div>
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        ...
                        <?php echo "".$get_data_admission->pr_id; ?>
...
<div class="row"><!-- Begin Row -->
  ...
  <!-- First Column -->
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_data_admission->pr_vaccinestat; ?></div>
         </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_data_admission->pr_divi; ?></div>
         </div>
