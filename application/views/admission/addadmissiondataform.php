...
<div class="container-fluid">
   ...
   <div class="row">             
     <div class="col-sm-6">
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800">
          <input class="form-control" type="text" name="e_chief_complaint" value="@gmail.com">   
         </div>
    ...
    <div class="col-sm-6">
        ...
        <div class="text-danger text-center"><?php echo form_error('e_age'); ?></div>
              ...
              <div style="margin-bottom:17px;">
                <div class="row no-gutters">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Guardian</div>   
                </div>
