...
<div class="container-fluid">
           ...
           <div style="margin-bottom:17px; ">
                <div class="row no-gutters">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Examined By</div>   
                </div>
        <div style="margin-right:20px;" class="h6 mb-1  text-gray-800">
        
         <div  class="col-sm-6 ">
                  <input class="form-control <?= (form_error('a_admitted') == "" ? '':'is-invalid') ?>" type="text" name="a_admitted" placeholder="Examined by" value="<?php echo set_value('a_admitted') ?>">       
