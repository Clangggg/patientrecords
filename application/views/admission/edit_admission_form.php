 ...
 <div style="margin-bottom:17px; margin-left:510px;">
     <div class=" no-gutters ">
         <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">STUDENT CASE NO.</div>
     </div>
 ...
 <div style="margin-left: 5px;" class="row">
     ...
     <div class="col-sm-6">
         <div style="margin-bottom:17px;">
             ...
             <div class="h4 mb-1 font-weight-bold text-gray-800">
                 <input class="form-control  <?= (form_error('e_admittedby') == "" ? '':'is-invalid') ?>" type="text"
                     name="e_admittedby" value="<?php echo $get_data_admission->ad_admittedby; ?>"
     ...
     <div class="ml-auto" style="margin-bottom:17px; margin-right: 50px;">
         <div class=" no-gutters ">
             <div class="text-xs font-weight-bold text-secondarysecondary text-uppercase mb-1">Reason of Admission</div>
         </div>
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             <select class="form-control" name="e_wardname">
                 <option
                     value=<?php echo $get_data_admission->ad_wardname; ?><?php echo set_select('e_wardname', $get_data_admission->ad_wardname); ?>>
                     <?php echo $get_data_admission->ad_wardname; ?></option>
                 <?php if(count($get_physician)): ?>
                 <?php foreach($get_ward as $ward): ?>
                 <option value=<?php echo $ward->w_name; ?><?php echo set_select('e_wardname', $ward->w_name); ?>>
 ...
 <div style="margin-left: 15px;" class="row">
     ...
     <div style="margin-bottom:17px; margin-right: 20px;">
         <div class=" no-gutters ">
             <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Name of Parents</div>
         </div>
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             <div class=" no-gutters ">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Father</div>
             </div>
             <input class="form-control  <?= (form_error('e_father') == "" ? '':'is-invalid') ?>" type="text"
                 name="e_father" value="<?php echo $get_data_admission->ad_father; ?>" placeholder="Enter Father">
         </div>
         ...
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             ...
             <input class="form-control  <?= (form_error('e_mother') == "" ? '':'is-invalid') ?>" type="text"
                 name="e_mother" value="<?php echo $get_data_admission->ad_mother; ?>" placeholder="Enter Mother">
         </div>
     ...
     <div class="ml-auto" style="margin-bottom:17px; margin-right: 40px;">
         ...
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             <input class="form-control  <?= (form_error('e_discharge') == "" ? '':'is-invalid') ?>" type="date"
                 name="e_discharge" value="<?php echo $get_data_admission->ad_dischargedate; ?>">
         </div>
 ...
 <div style="margin-left: 5px;" class="row">
     <div class="col-sm-6">
         <div style="margin-bottom:17px;">
             ...
             <div class="h4 mb-1 font-weight-bold text-gray-800">
                 <input class="form-control  <?= (form_error('e_chargeofaccount') == "" ? '':'is-invalid') ?>"
                     type="text" name="e_chargeofaccount" value="<?php echo $get_data_admission->ad_chargetoaccount; ?>"
                     placeholder="Enter Charge Account to">
             </div>
     ...
     <div class="ml-auto" style="margin-bottom:17px; margin-right: 40px;">
         ...
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             <input class="form-control  <?= (form_error('e_relationtopatient') == "" ? '':'is-invalid') ?>" type="text"
                 name="e_relationtopatient" value="<?php echo $get_data_admission->ad_relationtopatient; ?>"
 ...
 <div style="margin-left: 5px;" class="row">
     ...
     <div class="col-sm-12">
         <div style="margin-bottom:17px;">
             ...
             <div class="h4 mb-1 font-weight-bold text-gray-800">
                 <input class="form-control  <?= (form_error('e_address') == "" ? '':'is-invalid') ?>" type="text"
                     name="e_address" value="<?php echo $get_data_admission->ad_address; ?>" placeholder="Address">
             </div>
 ...
 <div style="margin-left: 5px;" class="row">
     <div class="col-sm-6">
         ...
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             <input class="form-control  <?= (form_error('e_number') == "" ? '':'is-invalid') ?>" type="text"
                 name="e_number" value="<?php echo $get_data_admission->ad_number; ?>"
                 placeholder="Enter Tel No./Mobile Number">
         </div>
     ...
     <div class="ml-auto" style="margin-bottom:17px; margin-right: 40px;">
         ...
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             <input class="form-control  <?= (form_error('e_totalpayment') == "" ? '':'is-invalid') ?>" type="text"
                 name="e_totalpayment" value="<?php echo $get_data_admission->ad_totalpayment; ?>"
 ...
 <div style="margin-left: 10px; margin-right: 10px;" class="row">
     <div class="col-sm-12">
         <div class=" no-gutters ">
             <div class="text-xs font-weight-bold text-secondarysecondary text-uppercase mb-1">Email Address</div>
         </div>
         <div class="h6 mb-1 text-gray-800">
             <input class="form-control <?= (form_error('e_complain') == "" ? '':'is-invalid') ?>" type="text"
                 name="e_complain" value="@gmail.com">
 ...
 <div style="margin-left: 10px; margin-right: 10px;" class="row">
     <div class="col-sm-12">
         ...
         <div class="h6 mb-1  text-gray-800">
             <input class="form-control <?= (form_error('e_completediagnosis') == "" ? '':'is-invalid') ?>" type="text"
                 name="e_completediagnosis" value="<?php echo $get_data_admission->ad_completediagnosis; ?>"
 ...
 <div style="margin-left: 10px; margin-right: 10px;" class="row">
     <div class="col-sm-12">
         ...
         <div class="h6 mb-1  text-gray-800">
             <input class="form-control <?= (form_error('e_medication') == "" ? '':'is-invalid') ?>" type="text"
                 name="e_medication" value="<?php echo $get_data_admission->ad_medication; ?>"
 ...
 <div style="margin-left: 10px; margin-right: 10px;" class="row">
     <div class="col-sm-12">
         ...
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             <input class="form-control  <?= (form_error('e_conditiondischarge') == "" ? '':'is-invalid') ?>"
                 type="text" name="e_conditiondischarge"
                 value="<?php echo $get_data_admission->ad_conditiontodischarge; ?>"
                 placeholder="Enter Condition to Discharge">
         </div>
     ...
     <div class="col-sm-12">
         ...
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             <input class="form-control  <?= (form_error('e_remarks') == "" ? '':'is-invalid') ?>" type="text"
                 name="e_remarks" value="<?php echo $get_data_admission->ad_remarks; ?>" placeholder="Enter Remarks">
         </div>
     ...
     <div class="col-sm-12">
         ...
         <div class="h4 mb-1 font-weight-bold text-gray-800">
             <select class="form-control" name="e_physician">
                 <option
                     value=<?php echo $get_data_admission->ad_physician; ?><?php echo set_select('e_physician', $get_data_admission->ad_physician); ?>>
                     <?php echo "Dr. ".$get_data_admission->ad_physician; ?></option>
                 <?php if(count($get_physician)): ?>
                 <?php foreach($get_physician as $physician): ?>
                 <option
                     value=<?php echo $physician->ph_name.' / '.$physician->ph_fieldofphysician; ?><?php echo set_select('e_physician', $physician->ph_name.' / '.$physician->ph_fieldofphysician); ?>>
                     <?php echo "Dr. ".$physician->ph_name.' / '.$physician->ph_fieldofphysician; ?></option>
                 <?php endforeach; ?>
                 <?php endif; ?>
             </select>
