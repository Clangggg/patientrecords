...
$this->form_validation->set_rules('a_chief_complaint', 'Eye/Ear/Nose');
$this->form_validation->set_rules('a_historyillness', 'Examination Details');
$this->form_validation->set_rules('a_bp', 'Blood Pressure');
$this->form_validation->set_rules('a_rr', 'Respiratory Rate');
$this->form_validation->set_rules('a_pulse', 'Pulse Rate');
$this->form_validation->set_rules('a_cr', 'Nutritional Status');
$this->form_validation->set_rules('a_temp', 'Temperature');
$this->form_validation->set_rules('a_wt', 'Weight');
$this->form_validation->set_rules('a_pr', 'Height');
$this->form_validation->set_rules('a_physicalexam', 'Visual Acuity');
$this->form_validation->set_rules('a_diagnosis', 'Hearing');
$this->form_validation->set_rules('a_medical_treatment', 'Skin/Scalp');
$this->form_validation->set_rules('a_mouth', 'Mouth');
$this->form_validation->set_rules('a_lungs', 'Lungs');
$this->form_validation->set_rules('a_abdo', 'Abdomen');
$this->form_validation->set_rules('a_spine', 'Spine');
$this->form_validation->set_rules('a_remarks', 'Remarks');
$this->form_validation->set_rules('a_others', 'Others');
$this->form_validation->set_rules('a_allergy', 'Allergy');
$this->form_validation->set_rules('a_asthma', 'Asthma');
$this->form_validation->set_rules('a_anemia', 'Anemia');
$this->form_validation->set_rules('a_bleeding', 'Bleeding problem');
$this->form_validation->set_rules('a_hailment', 'Heart ailment');
$this->form_validation->set_rules('a_diabetes', 'Diabetes');
$this->form_validation->set_rules('a_epilepsy', 'Epilepsy');
$this->form_validation->set_rules('a_kidney', 'Kidney problem');
$this->form_validation->set_rules('a_convulsion', 'Convulsion');
$this->form_validation->set_rules('a_fainting', 'Fainting');
$this->form_validation->set_rules('a_physician', 'Attending Physician');
$this->form_validation->set_rules('a_date', 'Date');
...
$this->form_validation->set_rules('a_oraldate', 'Oral Exam Date');
...
$this->form_validation->set_rules('a_oralphys', 'Dental Physician' );
